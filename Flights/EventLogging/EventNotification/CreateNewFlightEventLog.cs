...
{
    public class CreateNewFlightEventLog : EventLog
    {
        public CreateNewFlightEventLog()
        {

        }

        public CreateNewFlightEventLog(Guid entityId, string departureAirportCode, string departureAirportName, string destinationAirportCode, string destinationAirportName, double flightTime, double distance, double fuelNeeded, double takeOffEffort)
        {
